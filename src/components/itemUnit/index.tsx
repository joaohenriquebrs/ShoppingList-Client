...
export default function ItemUnit({ id, name, amount, category, unit, onDelete, onCheckboxChange, onEdit }: ItemUnitProps) {
    ...
    switch (category) {
        case 'FRUTA': currentIcon = FruitIcon; break;
        case 'PADARIA': currentIcon = BakaryIcon; break;
        case 'LEGUME': currentIcon = VegetableIcon; break;
        case 'BEBIDA': currentIcon = DrinkIcon; break;
        case 'CARNE': currentIcon = MeatIcon; break;
        default: currentIcon = FruitIcon; break;
    }
                ...
                <ModalOverlay>
                    <ModalContainer>
                        <ModalContent>
                            ...
                            />
                            <ModalButtonContainer>
                                <CancelButton onClick={handleCloseModalEdit}>Cancelar</CancelButton>
